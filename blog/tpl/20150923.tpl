<div class="blog-post">
    ...
    <div class="tabs">
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="active"><a href="#rules1" aria-controls="rules1" role="tab" data-toggle="tab">分类方法</a></li>
            <li role="presentation"><a href="#rules2" aria-controls="rules2" role="tab" data-toggle="tab">命名规则</a></li>
            <li role="presentation"><a href="#rules3" aria-controls="rules3" role="tab" data-toggle="tab">代码格式</a></li>
            <li role="presentation"><a href="#rules4" aria-controls="rules4" role="tab" data-toggle="tab">优化方案</a></li>
            <li role="presentation"><a href="#rules5" aria-controls="rules5" role="tab" data-toggle="tab">最佳实践</a></li>
            <li role="presentation"><a href="#rules6" aria-controls="rules6" role="tab" data-toggle="tab">典型错误</a></li>
        </ul>
        <!-- Tab panes -->
        <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane fade" id="rules2">
                ...
                <p>注：在你样式中的选择器总是要以上面前五类开头，然后在里面使用后代选择器。<br/>
                    如果这五类不能满足你的需求，你可以另外定义一个或多个大类，但必须符合单个字母+"-"为前缀的命名规则，即 .x- 的格式。<br/>
                    特殊：.j-将被专用于JS获取节点，请勿使用.j-定义样式。
                </p>
                <h3>后代选择器命名</h3>
                <p>
                    约定不以单个字母+"-"为前缀且长度大于等于2的类选择器为后代选择器，如：.item为m-list模块里的每一个项，.text为m-list模块里的文本部分：.m-list .item{}.m-list .text{}。<br/>
                    一个语义化的标签也可以是后代选择器，比如：.m-list li{}。<br/>
                    不允许单个字母的类选择器出现，原因详见下面的“模块和元件的后代选择器的扩展类”。
                </p>
                <p>
                    通过使用后代选择器的方法，你不需要考虑他的命名是否已被使用，因为他只在当前模块或元件中生效，同样的样式名可以在不同的模块或元件中重复使用，互不干扰；在多人协作或者分模块协作的时候效果尤为明显！<br/>
                    后代选择器不需要完整表现结构树层级，尽量能短则短。<br/>
                ...
                <h3>相同语义的不同类命名</h3>
                <p>
                    方法：直接加数字或字母区分即可（如：.m-list、.m-list2、.m-list3等，都是列表模块，但是是完全不一样的模块）。<br/>
                    其他举例：.f-fw0、.f-fw1、.s-fc0、.s-fc1、.m-logo2、.m-logo3、u-btn、u-btn2等等。
                </p>
                <h3>模块和元件的扩展类的命名方法</h3>
                <p>
                    当A、B、C、...它们类型相同且外形相似区别不大，那么就以它们中出现率最高的做成基类，其他做成基类的扩展。<br/>
                    方法：+“-”+数字或字母（如：.m-list的扩展类为.m-list-1、.m-list-2等）。<br/>
                    补充：基类自身可以独立使用（如：class="m-list"即可），扩展类必须基于基类使用（如：class="m-list m-list-2"）。<br/>
                    如果你的扩展类是表示不同状态，那么你可以这样命名：u-btn-dis，u-btn-hov，m-box-sel，m-box-hov等等，然后像这样使用：class="u-btn u-btn-dis"。<br/>
                    如果你的网站可以不兼容IE6等浏览器，那么你标识状态的方法也可以采取独立状态分类（.z-）方法：.u-btn.z-dis，.m-box.z-sel，然后像这样使用：class="u-btn z-dis"。
                </p>
                <h3>模块和元件的后代选择器的扩展类</h3>
                <p>
                    有时候模块内会有些类似的东西，如果你没有把它们做成元件和扩展，那么也可以使用后代选择器和扩展。<br/>
                    后代选择器：.m-login .btn{}。<br/>
                    后代选择器扩展：.m-login .btn-1{}，.m-login .btn-dis{}。<br/>
                    同样也可以采取独立状态分类（.z-）方法：.m-login .btn.z-dis{}，然后像这样使用：class="btn z-dis"。<br/>
                    注：此方法用于类选择器，直接使用标签做为选择器的则不需要使用此命名方法。<br/>
                    注：为防止后代选择器的扩展类和大类命名规范冲突，后代选择器不允许使用单个字母。<br/>
                    比如：.m-list .a{}是不允许的，因为当这个.a需要扩展的时候就会变成.a-bb，这样就和大类的命名规范冲突。
                </p>
                <h3>分组选择器有时可以代替扩展方法</h3>
                <p>
                    有时候虽然两个同类型的模块很相似，但是你希望他们之间不要有依赖关系，也就是说你不希望使用扩展的方法，那么你可以通过合并选择器来设置共性的样式。<br/>
                ...
                <h3>防止污染和被污染</h3>
                <p>
                    当模块或元件之间互相嵌套，且使用了相同的标签选择器或其他后代选择器，那么里面的选择器就会被外面相同的选择器所影响。<br/>
            ...
            <div role="tabpanel" class="tab-pane fade" id="rules3">
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        <thead>
                        <tr>
                            <td>显示属性</td><td>自身属性</td><td>文本属性和其他修饰</td>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
                            <td>display</td><td>width</td><td>font</td>
                        </tr>
                        <tr>
                            <td>visibility</td><td>height</td><td>text-align</td>
                        </tr>
                        <tr>
                            <td>position</td><td>margin</td><td>text-decoration</td>
                        </tr>
                        <tr>
                            <td>float</td><td>padding</td><td>vertical-align</td>
                        </tr>
                        <tr>
                            <td>clear</td><td>border</td><td>white-space</td>
                        </tr>
                        <tr>
                            <td>list-style</td><td>overflow</td><td>color</td>
                        </tr>
                        <tr>
                            <td>top</td><td>min-width</td><td>background</td>
                        </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <h3>注释格式：/* 注释文字 */</h3>
                <p>对选择器的注释统一写在被注释对象的上一行，对属性及值的注释写于分号后。<br/>
                    注释内容两端需空格，已确保即使在编码错误的情况下也可以正确解析样式。<br/>
                    在必要的情况下，可以使用块状注释，块状注释保持统一的缩进对齐。<br/>
                    原则上每个系列的样式都需要有一个注释，言简意赅的表明名称、用途、注意事项等。</p>
                <pre><code>/* 块状注释文字
                    * 块状注释文字
                    * 块状注释文字
                    */
                ...
                <h3>原则上不允许使用Hack</h3>
                <p>很多不兼容问题可以通过改变方法和思路来解决，并非一定需要Hack，根据经验你完全可以绕过某些兼容问题。<br/>
                    一种合理的结构和合理的样式，是极少会碰到兼容问题的。<br/>
                    由于浏览器自身缺陷，我们无法避开的时候，可以允许使用适当的Hack。</p>
                <h3>统一Hack方法</h3>
                ...
                <h3>建议并适当缩写值</h3>
                <p>“建议并适当”是因为缩写总是会包含一系列的值，而有时候我们并不希望设置某一值，反而造成了麻烦，那么这时候你可以不缩写，而是分开写。<br/>
                    当然，在一切可以缩写的情况下，请务必缩写，它最大的好处就是节省了字节，便于维护，并使阅读更加一目了然。<br/>
                    缩写方法请查阅css手册。</p>
                <h3>选择器顺序</h3>
                <p>请综合考虑以下顺序依据：</p>
                <ol class="ol">
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        <thead>
                        <tr>
                            <td>选择器</td><td>等级(a,b,c,d)</td>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
                            <td>style=””</td><td>1,0,0,0</td>
                        </tr>
                        <tr>
                            <td>#wrapper #content {}</td><td>0,2,0,0</td>
                        </tr>
                        <tr>
                            <td>#content .dateposted {}</td><td>0,1,1,0</td>
                        </tr>
                        <tr>
                            <td>div#content {}</td><td>0,1,0,1</td>
                        </tr>
                        <tr>
                            <td>#content p {}</td><td>0,1,0,1</td>
                        </tr>
                        <tr>
                            <td>#content {}</td><td>0,1,0,0</td>
                        </tr>
                        <tr>
                            <td>p.comment .dateposted {}</td><td>0,0,2,1</td>
                        </tr>
                        <tr>
                            <td>div.comment p {}</td><td>0,0,1,2</td>
                        </tr>
                        <tr>
                            <td>.comment p {}</td><td>0,0,1,1</td>
                        </tr>
                        <tr>
                            <td>p.comment {}</td><td>0,0,1,1</td>
                        </tr>
                        <tr>
                            <td>.comment {}</td><td>0,0,1,0</td>
                        </tr>
                        <tr>
                            <td>div p {}</td><td>0,0,0,2</td>
                        </tr>
                        <tr>
                            <td>p {}</td><td>0,0,0,1</td>
                        </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div role="tabpanel" class="tab-pane fade" id="rules4">
                <h3>值缩写</h3>
                <p>缩写值可以减少CSS文件大小，并增加可读性和可维护性。<br/>
                    但并非所有的值都必须缩写，因为当一个属性的值缩写时，总是会将所有项都设置一遍，而有时候我们不希望设置值里的某些项。</p>
                ...
                <h3>选择器合并</h3>
                <p>即CSS选择器组合，可以一次定义多个选择器，为你节省很多字节和宝贵时间。<br/>
                    通常我们会将定义相同的或者有大部分属性值相同（确实是因为相关而相同）的一系列选择器组合到一起（采用逗号的方法）来统一定义。</p>
                ...
                <h3>便于阅读修改</h3>
                <p>如果你做到了“CSS规范”的所有要求，自然你也就写出了一个便于阅读和修改的漂亮的CSS。<br/>
                    当然，代码格式和命名规则是相对重要一些的。</p>
                <h3>清晰的CSS模块</h3>
                <p>如果你做到了命名规则的要求，你的CSS模块也就清晰可见了。<br/>
                    用“注释”来说明每一个模块对于较大的CSS文件来说显得尤为重要。</p>
                <h3>文件压缩</h3>
            ...
            <div role="tabpanel" class="tab-pane fade" id="rules5">
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                        <tr><td>导航</td><td>nav</td></tr>
                        <tr><td>子导航</td><td>subnav</td></tr>
                        <tr><td>面包屑</td><td>crumb</td></tr>
                        <tr><td>菜单</td><td>menu</td></tr>
                        <tr><td>选项卡</td><td>tab</td></tr>
                        <tr><td>标题区</td><td>head/title</td></tr>
                        <tr><td>内容区</td><td>body/content</td></tr>
                        <tr><td>列表</td><td>list</td></tr>
                        <tr><td>表格</td><td>table</td></tr>
                        <tr><td>表单</td><td>form</td></tr>
                        <tr><td>热点</td><td>hot</td></tr>
                        <tr><td>排行</td><td>top</td></tr>
                        <tr><td>登录</td><td>login</td></tr>
                        <tr><td>标志</td><td>logo</td></tr>
                        <tr><td>广告</td><td>advertise</td></tr>
                        <tr><td>搜索</td><td>search</td></tr>
                        <tr><td>幻灯</td><td>slide</td></tr>
                        <tr><td>提示</td><td>tips</td></tr>
                        <tr><td>帮助</td><td>help</td></tr>
                        <tr><td>新闻</td><td>news</td></tr>
                        <tr><td>注册</td><td>regist</td></tr>
                        <tr><td>下载</td><td>vote</td></tr>
                        <tr><td>投票</td><td>help</td></tr>
                        <tr><td>结果</td><td>result</td></tr>
                        <tr><td>标题</td><td>title</td></tr>
                        <tr><td>按钮</td><td>button</td></tr>
                        <tr><td>输入</td><td>input</td></tr>
                        </tbody>
                    </table>
                </div>
                <h4>功能（.f-）</h4>
                <div class="table-responsive">
                    <table class="table table-hover">
                        <thead>
                        <tr><td>语义</td><td>命名</td><td>简写</td></tr>
                        </thead>
                        <tbody>
